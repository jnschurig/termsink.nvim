local highlights = require "termsink.highlights"
...
local prepare_environment = function()
    ...
    if vim.g.termsink_style == "lighter" then
...
local apply_contrast = function(contrast_settings)
    ...
    -- clean up autogroups if the theme is not termsink
    vim.api.nvim_create_autocmd("ColorScheme", { callback = function()
        if vim.g.colors_name ~= "termsink" then
